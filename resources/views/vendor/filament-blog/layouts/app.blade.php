...
<body class="antialiased">
    <div class="min-h-screen">
        ...
        <div class="fixed bottom-0 left-0 z-50 h-20 w-full border-t border-gray-200 bg-white sm:hidden">
            <div class="mx-auto grid h-full max-w-lg grid-cols-3 justify-center font-medium">
                <a href="{{ route('home') }}"
                    class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mb-1 w-6">
                ...
                <a href="{{ route('filamentblog.post.index') }}"
                    ...
                    <span class="text-sm text-gray-500 group-hover:text-blue-600 dark:text-gray-400">Blog</span>
                </a>
